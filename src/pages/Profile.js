...
async function updateUserProfile(details) {
  const firebaseApiUrl = `https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyBxmN7U0TnbCcdz-VjYAe4liAz7oYG6wlQ`;
...
async function getUserProfile(idToken) {
  const firebaseApiUrl = `https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyBxmN7U0TnbCcdz-VjYAe4liAz7oYG6wlQ`;
...
async function verifyEmail(idToken) {
  const firebaseApiUrl = `https://identitytoolkit.googleapis.com/v1/accounts:sendOobCode?key=AIzaSyBxmN7U0TnbCcdz-VjYAe4liAz7oYG6wlQ`;
